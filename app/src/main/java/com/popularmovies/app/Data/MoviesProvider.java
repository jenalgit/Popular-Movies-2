...
import com.popularmovies.app.Data.MoviesContract.MovieEntry;
import com.popularmovies.app.Data.MoviesContract.MovieReviewEntry;
import com.popularmovies.app.Data.MoviesContract.MovieTrailerEntry;
...
public class MoviesProvider extends ContentProvider {
    ...
    private void normalizeDate(ContentValues values) {
        ...
        if (values.containsKey(MovieEntry.COLUMN_DATE)) {
            ...
            values.put(MovieEntry.COLUMN_DATE, MoviesContract.normalizeDate(dateValue));
        }
    }
